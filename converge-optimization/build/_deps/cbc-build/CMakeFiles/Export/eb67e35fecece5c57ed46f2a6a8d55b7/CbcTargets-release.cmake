...
set_target_properties(Coin::Cbc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libCbc.2.10.12.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libCbc.2.dylib"
  )

list(APPEND _cmake_import_check_targets Coin::Cbc )
list(APPEND _cmake_import_check_files_for_Coin::Cbc "${_IMPORT_PREFIX}/lib/libCbc.2.10.12.dylib" )
...
set_target_properties(Coin::OsiCbc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOsiCbc.2.10.12.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libOsiCbc.2.dylib"
  )

list(APPEND _cmake_import_check_targets Coin::OsiCbc )
list(APPEND _cmake_import_check_files_for_Coin::OsiCbc "${_IMPORT_PREFIX}/lib/libOsiCbc.2.10.12.dylib" )
...
set_target_properties(Coin::CbcSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libCbcSolver.2.10.12.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libCbcSolver.2.dylib"
  )

list(APPEND _cmake_import_check_targets Coin::CbcSolver )
list(APPEND _cmake_import_check_files_for_Coin::CbcSolver "${_IMPORT_PREFIX}/lib/libCbcSolver.2.10.12.dylib" )

...
set_target_properties(Coin::Clp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libClp.1.17.10.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libClp.1.dylib"
  )

list(APPEND _cmake_import_check_targets Coin::Clp )
list(APPEND _cmake_import_check_files_for_Coin::Clp "${_IMPORT_PREFIX}/lib/libClp.1.17.10.dylib" )
...
set_target_properties(Coin::OsiClp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOsiClp.1.17.10.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libOsiClp.1.dylib"
  )

list(APPEND _cmake_import_check_targets Coin::OsiClp )
list(APPEND _cmake_import_check_files_for_Coin::OsiClp "${_IMPORT_PREFIX}/lib/libOsiClp.1.17.10.dylib" )
...
set_target_properties(Coin::ClpSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libClpSolver.1.17.10.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libClpSolver.1.dylib"
  )

list(APPEND _cmake_import_check_targets Coin::ClpSolver )
list(APPEND _cmake_import_check_files_for_Coin::ClpSolver "${_IMPORT_PREFIX}/lib/libClpSolver.1.17.10.dylib" )

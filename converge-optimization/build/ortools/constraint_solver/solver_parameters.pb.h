...
extern "C" {
OR_PROTO_DLL extern const ::google::protobuf::internal::DescriptorTable descriptor_table_ortools_2fconstraint_5fsolver_2fsolver_5fparameters_2eproto;
}  // extern "C"
...
OR_PROTO_DLL extern const ::google::protobuf::internal::ClassDataFull ConstraintSolverParameters_class_data_;
}  // namespace operations_research
namespace google {
namespace protobuf {
template <>
internal::EnumTraitsT<::operations_research::ConstraintSolverParameters_TrailCompression_internal_data_>
    internal::EnumTraitsImpl::value<::operations_research::ConstraintSolverParameters_TrailCompression>;
}  // namespace protobuf
}  // namespace google
...
OR_PROTO_DLL extern const uint32_t ConstraintSolverParameters_TrailCompression_internal_data_[];
inline constexpr ConstraintSolverParameters_TrailCompression ConstraintSolverParameters_TrailCompression_TrailCompression_MIN =
    static_cast<ConstraintSolverParameters_TrailCompression>(0);
inline constexpr ConstraintSolverParameters_TrailCompression ConstraintSolverParameters_TrailCompression_TrailCompression_MAX =
    static_cast<ConstraintSolverParameters_TrailCompression>(1);
inline bool ConstraintSolverParameters_TrailCompression_IsValid(int value) {
  return 0 <= value && value <= 1;
}
inline constexpr int ConstraintSolverParameters_TrailCompression_TrailCompression_ARRAYSIZE = 1 + 1;
OR_PROTO_DLL const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL ConstraintSolverParameters_TrailCompression_descriptor();
template <typename T>
...
inline const ::std::string& ConstraintSolverParameters_TrailCompression_Name(ConstraintSolverParameters_TrailCompression value) {
  return ::google::protobuf::internal::NameOfDenseEnum<ConstraintSolverParameters_TrailCompression_descriptor, 0, 1>(
      static_cast<int>(value));
}
inline bool ConstraintSolverParameters_TrailCompression_Parse(
    ::absl::string_view name, ConstraintSolverParameters_TrailCompression* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<ConstraintSolverParameters_TrailCompression>(ConstraintSolverParameters_TrailCompression_descriptor(), name,
                                           value);
}
...
/* @@protoc_insertion_point(class_definition:operations_research.ConstraintSolverParameters) */ {
 public:
  ...
  void operator delete(ConstraintSolverParameters* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  inline void Swap(ConstraintSolverParameters* PROTOBUF_NONNULL other) {
  ...
  void InternalSwap(ConstraintSolverParameters* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "operations_research.ConstraintSolverParameters"; }

  explicit ConstraintSolverParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  ConstraintSolverParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const ConstraintSolverParameters& from);
  ConstraintSolverParameters(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, ConstraintSolverParameters&& from) noexcept
 ...
 public:
  ...
  static inline const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL TrailCompression_descriptor() {
  ...
  static inline bool TrailCompression_Parse(
      ::absl::string_view name, TrailCompression* PROTOBUF_NONNULL value) {
  ...
  [[nodiscard]] ::std::string* PROTOBUF_NULLABLE release_profile_file();
  void set_allocated_profile_file(::std::string* PROTOBUF_NULLABLE value);

  private:
  const ::std::string& _internal_profile_file() const;
  PROTOBUF_ALWAYS_INLINE void _internal_set_profile_file(const ::std::string& value);
  ::std::string* PROTOBUF_NONNULL _internal_mutable_profile_file();
...
PROTOBUF_ALWAYS_INLINE void ConstraintSolverParameters::set_profile_file(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::std::string* PROTOBUF_NONNULL ConstraintSolverParameters::mutable_profile_file()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
...
inline ::std::string* PROTOBUF_NONNULL ConstraintSolverParameters::_internal_mutable_profile_file() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.profile_file_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE ConstraintSolverParameters::release_profile_file() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  auto* released = _impl_.profile_file_.Release();
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString()) {
    _impl_.profile_file_.Set("", GetArena());
  }
  return released;
}
inline void ConstraintSolverParameters::set_allocated_profile_file(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  } else {
...
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::operations_research::ConstraintSolverParameters_TrailCompression>() {

...
extern "C" {
OR_PROTO_DLL extern const ::google::protobuf::internal::DescriptorTable descriptor_table_ortools_2fconstraint_5fsolver_2fsearch_5flimit_2eproto;
}  // extern "C"
...
OR_PROTO_DLL extern const ::google::protobuf::internal::ClassDataFull RegularLimitParameters_class_data_;
}  // namespace operations_research
namespace google {
namespace protobuf {
}  // namespace protobuf
...
/* @@protoc_insertion_point(class_definition:operations_research.RegularLimitParameters) */ {
 public:
  ...
  void operator delete(RegularLimitParameters* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  inline void Swap(RegularLimitParameters* PROTOBUF_NONNULL other) {
  ...
  void InternalSwap(RegularLimitParameters* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "operations_research.RegularLimitParameters"; }

  explicit RegularLimitParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  ...
  RegularLimitParameters(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, RegularLimitParameters&& from) noexcept

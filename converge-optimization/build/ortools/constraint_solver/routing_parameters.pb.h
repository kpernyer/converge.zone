...
extern "C" {
OR_PROTO_DLL extern const ::google::protobuf::internal::DescriptorTable descriptor_table_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto;
}  // extern "C"
...
OR_PROTO_DLL extern const ::google::protobuf::internal::ClassDataFull RoutingModelParameters_class_data_;
...
OR_PROTO_DLL extern const ::google::protobuf::internal::ClassDataFull RoutingSearchParameters_class_data_;
...
OR_PROTO_DLL extern const ::google::protobuf::internal::ClassDataFull RoutingSearchParameters_ImprovementSearchLimitParameters_class_data_;
...
OR_PROTO_DLL extern const ::google::protobuf::internal::ClassDataFull RoutingSearchParameters_LocalSearchNeighborhoodOperators_class_data_;
}  // namespace operations_research
namespace google {
namespace protobuf {
template <>
internal::EnumTraitsT<::operations_research::RoutingSearchParameters_SchedulingSolver_internal_data_>
    internal::EnumTraitsImpl::value<::operations_research::RoutingSearchParameters_SchedulingSolver>;
}  // namespace protobuf
}  // namespace google
...
OR_PROTO_DLL extern const uint32_t RoutingSearchParameters_SchedulingSolver_internal_data_[];
inline constexpr RoutingSearchParameters_SchedulingSolver RoutingSearchParameters_SchedulingSolver_SchedulingSolver_MIN =
    static_cast<RoutingSearchParameters_SchedulingSolver>(0);
inline constexpr RoutingSearchParameters_SchedulingSolver RoutingSearchParameters_SchedulingSolver_SchedulingSolver_MAX =
    static_cast<RoutingSearchParameters_SchedulingSolver>(2);
inline bool RoutingSearchParameters_SchedulingSolver_IsValid(int value) {
  return 0 <= value && value <= 2;
}
inline constexpr int RoutingSearchParameters_SchedulingSolver_SchedulingSolver_ARRAYSIZE = 2 + 1;
OR_PROTO_DLL const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL RoutingSearchParameters_SchedulingSolver_descriptor();
template <typename T>
...
inline const ::std::string& RoutingSearchParameters_SchedulingSolver_Name(RoutingSearchParameters_SchedulingSolver value) {
  return ::google::protobuf::internal::NameOfDenseEnum<RoutingSearchParameters_SchedulingSolver_descriptor, 0, 2>(
      static_cast<int>(value));
}
inline bool RoutingSearchParameters_SchedulingSolver_Parse(
    ::absl::string_view name, RoutingSearchParameters_SchedulingSolver* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<RoutingSearchParameters_SchedulingSolver>(RoutingSearchParameters_SchedulingSolver_descriptor(), name,
                                           value);
}
...
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators) */ {
 public:
  ...
  void operator delete(RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  inline void Swap(RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NONNULL other) {
  ...
  void InternalSwap(RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  ...
  explicit RoutingSearchParameters_LocalSearchNeighborhoodOperators(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  ...
  RoutingSearchParameters_LocalSearchNeighborhoodOperators(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, RoutingSearchParameters_LocalSearchNeighborhoodOperators&& from) noexcept
 ...
 public:
  ...
  enum : int {
    ...
    kUseLocalCheapestInsertionVisitTypesLnsFieldNumber = 40,
    ...
    kUseGlobalCheapestInsertionVisitTypesLnsFieldNumber = 39,
  };
  ...
  private:
  ::operations_research::OptionalBoolean _internal_use_local_cheapest_insertion_visit_types_lns() const;
  void _internal_set_use_local_cheapest_insertion_visit_types_lns(::operations_research::OptionalBoolean value);
  ...
  private:
  ::operations_research::OptionalBoolean _internal_use_global_cheapest_insertion_visit_types_lns() const;
  void _internal_set_use_global_cheapest_insertion_visit_types_lns(::operations_research::OptionalBoolean value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    int use_local_cheapest_insertion_visit_types_lns_;
    ...
    int use_global_cheapest_insertion_visit_types_lns_;
...
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters.ImprovementSearchLimitParameters) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  inline void Swap(RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NONNULL other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void SharedCtor(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  static void SharedDtor(MessageLite& self);
  void InternalSwap(RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  ...
  explicit RoutingSearchParameters_ImprovementSearchLimitParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  RoutingSearchParameters_ImprovementSearchLimitParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const RoutingSearchParameters_ImprovementSearchLimitParameters& from);
  RoutingSearchParameters_ImprovementSearchLimitParameters(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, RoutingSearchParameters_ImprovementSearchLimitParameters&& from) noexcept
...
/* @@protoc_insertion_point(class_definition:operations_research.RoutingModelParameters) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(RoutingModelParameters* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  inline void Swap(RoutingModelParameters* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(RoutingModelParameters* PROTOBUF_NONNULL other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  RoutingModelParameters* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void SharedCtor(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  static void SharedDtor(MessageLite& self);
  void InternalSwap(RoutingModelParameters* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "operations_research.RoutingModelParameters"; }

  explicit RoutingModelParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  RoutingModelParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const RoutingModelParameters& from);
  RoutingModelParameters(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, RoutingModelParameters&& from) noexcept
 ...
 public:
  ...
  [[nodiscard]] ::operations_research::ConstraintSolverParameters* PROTOBUF_NULLABLE release_solver_parameters();
  ...
  ::operations_research::ConstraintSolverParameters* PROTOBUF_NONNULL _internal_mutable_solver_parameters();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    ::operations_research::ConstraintSolverParameters* PROTOBUF_NULLABLE solver_parameters_;
...
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(RoutingSearchParameters* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  inline void Swap(RoutingSearchParameters* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  void SharedCtor(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  static void SharedDtor(MessageLite& self);
  void InternalSwap(RoutingSearchParameters* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "operations_research.RoutingSearchParameters"; }

  explicit RoutingSearchParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  RoutingSearchParameters(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const RoutingSearchParameters& from);
  RoutingSearchParameters(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, RoutingSearchParameters&& from) noexcept
 ...
 public:
  ...
  static inline const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL SchedulingSolver_descriptor() {
  ...
  static inline bool SchedulingSolver_Parse(
      ::absl::string_view name, SchedulingSolver* PROTOBUF_NONNULL value) {
  ...
  enum : int {
    ...
    kGlobalCheapestInsertionFirstSolutionParametersFieldNumber = 71,
    ...
    kLocalCheapestInsertionParametersFieldNumber = 68,
    kLocalCheapestCostInsertionParametersFieldNumber = 69,
    kSavingsParametersFieldNumber = 70,
    kGlobalCheapestInsertionLsOperatorParametersFieldNumber = 72,
  ...
  [[nodiscard]] ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NULLABLE release_local_search_operators();
  ...
  ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NONNULL _internal_mutable_local_search_operators();
  ...
  [[nodiscard]] ::google::protobuf::Duration* PROTOBUF_NULLABLE release_lns_time_limit();
  ...
  ::google::protobuf::Duration* PROTOBUF_NONNULL _internal_mutable_lns_time_limit();
  ...
  [[nodiscard]] ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NULLABLE release_improvement_limit_parameters();
  ...
  ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NONNULL _internal_mutable_improvement_limit_parameters();
  ...
  [[nodiscard]] ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE release_global_cheapest_insertion_first_solution_parameters();
  ...
  private:
  const ::operations_research::GlobalCheapestInsertionParameters& _internal_global_cheapest_insertion_first_solution_parameters() const;
  ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NONNULL _internal_mutable_global_cheapest_insertion_first_solution_parameters();
  ...
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL _internal_mutable_local_search_metaheuristics();
  ...
  [[nodiscard]] ::std::string* PROTOBUF_NULLABLE release_log_tag();
  void set_allocated_log_tag(::std::string* PROTOBUF_NULLABLE value);

  private:
  const ::std::string& _internal_log_tag() const;
  PROTOBUF_ALWAYS_INLINE void _internal_set_log_tag(const ::std::string& value);
  ::std::string* PROTOBUF_NONNULL _internal_mutable_log_tag();
  ...
  [[nodiscard]] ::operations_research::sat::SatParameters* PROTOBUF_NULLABLE release_sat_parameters();
  ...
  ::operations_research::sat::SatParameters* PROTOBUF_NONNULL _internal_mutable_sat_parameters();
  ...
  [[nodiscard]] ::operations_research::IteratedLocalSearchParameters* PROTOBUF_NULLABLE release_iterated_local_search_parameters();
  ...
  ::operations_research::IteratedLocalSearchParameters* PROTOBUF_NONNULL _internal_mutable_iterated_local_search_parameters();
  ...
  [[nodiscard]] ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE release_local_cheapest_insertion_parameters();
  ...
  private:
  const ::operations_research::LocalCheapestInsertionParameters& _internal_local_cheapest_insertion_parameters() const;
  ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NONNULL _internal_mutable_local_cheapest_insertion_parameters();
  ...
  [[nodiscard]] ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE release_local_cheapest_cost_insertion_parameters();
  ...
  private:
  const ::operations_research::LocalCheapestInsertionParameters& _internal_local_cheapest_cost_insertion_parameters() const;
  ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NONNULL _internal_mutable_local_cheapest_cost_insertion_parameters();
  ...
  [[nodiscard]] ::operations_research::SavingsParameters* PROTOBUF_NULLABLE release_savings_parameters();
  ...
  private:
  const ::operations_research::SavingsParameters& _internal_savings_parameters() const;
  ::operations_research::SavingsParameters* PROTOBUF_NONNULL _internal_mutable_savings_parameters();
  ...
  [[nodiscard]] ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE release_global_cheapest_insertion_ls_operator_parameters();
  ...
  private:
  const ::operations_research::GlobalCheapestInsertionParameters& _internal_global_cheapest_insertion_ls_operator_parameters() const;
  ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NONNULL _internal_mutable_global_cheapest_insertion_ls_operator_parameters();
 ...
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<5, 50,
                                   11, 107,
                                   11>
      _table_;
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<2> _has_bits_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NULLABLE local_search_operators_;
    ::google::protobuf::Duration* PROTOBUF_NULLABLE time_limit_;
    ::google::protobuf::Duration* PROTOBUF_NULLABLE lns_time_limit_;
    ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NULLABLE improvement_limit_parameters_;
    ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE global_cheapest_insertion_first_solution_parameters_;
    ...
    ::operations_research::sat::SatParameters* PROTOBUF_NULLABLE sat_parameters_;
    ::operations_research::IteratedLocalSearchParameters* PROTOBUF_NULLABLE iterated_local_search_parameters_;
    ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE local_cheapest_insertion_parameters_;
    ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE local_cheapest_cost_insertion_parameters_;
    ::operations_research::SavingsParameters* PROTOBUF_NULLABLE savings_parameters_;
    ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE global_cheapest_insertion_ls_operator_parameters_;
...
// .operations_research.OptionalBoolean use_global_cheapest_insertion_visit_types_lns = 39;
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::clear_use_global_cheapest_insertion_visit_types_lns() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_global_cheapest_insertion_visit_types_lns_ = 0;
  ClearHasBit(_impl_._has_bits_[1],
                  0x00000080U);
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::use_global_cheapest_insertion_visit_types_lns() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_global_cheapest_insertion_visit_types_lns)
  return _internal_use_global_cheapest_insertion_visit_types_lns();
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::set_use_global_cheapest_insertion_visit_types_lns(::operations_research::OptionalBoolean value) {
  _internal_set_use_global_cheapest_insertion_visit_types_lns(value);
  SetHasBit(_impl_._has_bits_[1], 0x00000080U);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_global_cheapest_insertion_visit_types_lns)
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_use_global_cheapest_insertion_visit_types_lns() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::operations_research::OptionalBoolean>(_impl_.use_global_cheapest_insertion_visit_types_lns_);
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_set_use_global_cheapest_insertion_visit_types_lns(::operations_research::OptionalBoolean value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_global_cheapest_insertion_visit_types_lns_ = value;
}

// .operations_research.OptionalBoolean use_local_cheapest_insertion_visit_types_lns = 40;
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::clear_use_local_cheapest_insertion_visit_types_lns() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_local_cheapest_insertion_visit_types_lns_ = 0;
  ClearHasBit(_impl_._has_bits_[0],
                  0x80000000U);
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::use_local_cheapest_insertion_visit_types_lns() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_local_cheapest_insertion_visit_types_lns)
  return _internal_use_local_cheapest_insertion_visit_types_lns();
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::set_use_local_cheapest_insertion_visit_types_lns(::operations_research::OptionalBoolean value) {
  _internal_set_use_local_cheapest_insertion_visit_types_lns(value);
  SetHasBit(_impl_._has_bits_[0], 0x80000000U);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_local_cheapest_insertion_visit_types_lns)
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_use_local_cheapest_insertion_visit_types_lns() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::operations_research::OptionalBoolean>(_impl_.use_local_cheapest_insertion_visit_types_lns_);
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_set_use_local_cheapest_insertion_visit_types_lns(::operations_research::OptionalBoolean value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_local_cheapest_insertion_visit_types_lns_ = value;
}
...
// .operations_research.SavingsParameters savings_parameters = 70;
inline bool RoutingSearchParameters::has_savings_parameters() const {
  bool value = CheckHasBit(_impl_._has_bits_[1], 0x00000004U);
  PROTOBUF_ASSUME(!value || _impl_.savings_parameters_ != nullptr);
  return value;
}
inline const ::operations_research::SavingsParameters& RoutingSearchParameters::_internal_savings_parameters() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::operations_research::SavingsParameters* p = _impl_.savings_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::operations_research::SavingsParameters&>(::operations_research::_SavingsParameters_default_instance_);
}
inline const ::operations_research::SavingsParameters& RoutingSearchParameters::savings_parameters() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.savings_parameters)
  return _internal_savings_parameters();
}
inline void RoutingSearchParameters::unsafe_arena_set_allocated_savings_parameters(
    ::operations_research::SavingsParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.savings_parameters_);
  }
  _impl_.savings_parameters_ = reinterpret_cast<::operations_research::SavingsParameters*>(value);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[1], 0x00000004U);
  } else {
    ClearHasBit(_impl_._has_bits_[1], 0x00000004U);
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:operations_research.RoutingSearchParameters.savings_parameters)
}
inline ::operations_research::SavingsParameters* PROTOBUF_NULLABLE RoutingSearchParameters::release_savings_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  ClearHasBit(_impl_._has_bits_[1], 0x00000004U);
  ::operations_research::SavingsParameters* released = _impl_.savings_parameters_;
  _impl_.savings_parameters_ = nullptr;
...
inline ::operations_research::SavingsParameters* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_savings_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:operations_research.RoutingSearchParameters.savings_parameters)

  ClearHasBit(_impl_._has_bits_[1], 0x00000004U);
  ::operations_research::SavingsParameters* temp = _impl_.savings_parameters_;
  _impl_.savings_parameters_ = nullptr;
  return temp;
}
inline ::operations_research::SavingsParameters* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_savings_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.savings_parameters_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::SavingsParameters>(GetArena());
    _impl_.savings_parameters_ = reinterpret_cast<::operations_research::SavingsParameters*>(p);
  }
  return _impl_.savings_parameters_;
}
inline ::operations_research::SavingsParameters* PROTOBUF_NONNULL RoutingSearchParameters::mutable_savings_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[1], 0x00000004U);
  ::operations_research::SavingsParameters* _msg = _internal_mutable_savings_parameters();
  // @@protoc_insertion_point(field_mutable:operations_research.RoutingSearchParameters.savings_parameters)
  return _msg;
}
inline void RoutingSearchParameters::set_allocated_savings_parameters(::operations_research::SavingsParameters* PROTOBUF_NULLABLE value) {
  ...
  _impl_.savings_parameters_ = reinterpret_cast<::operations_research::SavingsParameters*>(value);
  // @@protoc_insertion_point(field_set_allocated:operations_research.RoutingSearchParameters.savings_parameters)
}

// .operations_research.GlobalCheapestInsertionParameters global_cheapest_insertion_first_solution_parameters = 71;
inline bool RoutingSearchParameters::has_global_cheapest_insertion_first_solution_parameters() const {
  bool value = CheckHasBit(_impl_._has_bits_[0], 0x00000010U);
  PROTOBUF_ASSUME(!value || _impl_.global_cheapest_insertion_first_solution_parameters_ != nullptr);
  return value;
}
inline const ::operations_research::GlobalCheapestInsertionParameters& RoutingSearchParameters::_internal_global_cheapest_insertion_first_solution_parameters() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::operations_research::GlobalCheapestInsertionParameters* p = _impl_.global_cheapest_insertion_first_solution_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::operations_research::GlobalCheapestInsertionParameters&>(::operations_research::_GlobalCheapestInsertionParameters_default_instance_);
}
inline const ::operations_research::GlobalCheapestInsertionParameters& RoutingSearchParameters::global_cheapest_insertion_first_solution_parameters() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.global_cheapest_insertion_first_solution_parameters)
  return _internal_global_cheapest_insertion_first_solution_parameters();
}
inline void RoutingSearchParameters::unsafe_arena_set_allocated_global_cheapest_insertion_first_solution_parameters(
    ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.global_cheapest_insertion_first_solution_parameters_);
  }
  _impl_.global_cheapest_insertion_first_solution_parameters_ = reinterpret_cast<::operations_research::GlobalCheapestInsertionParameters*>(value);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[0], 0x00000010U);
  } else {
    ClearHasBit(_impl_._has_bits_[0], 0x00000010U);
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:operations_research.RoutingSearchParameters.global_cheapest_insertion_first_solution_parameters)
}
inline ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE RoutingSearchParameters::release_global_cheapest_insertion_first_solution_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  ClearHasBit(_impl_._has_bits_[0], 0x00000010U);
  ::operations_research::GlobalCheapestInsertionParameters* released = _impl_.global_cheapest_insertion_first_solution_parameters_;
  _impl_.global_cheapest_insertion_first_solution_parameters_ = nullptr;
  if (::google::protobuf::internal::DebugHardenForceCopyInRelease()) {
    auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
    released = ::google::protobuf::internal::DuplicateIfNonNull(released);
    if (GetArena() == nullptr) {
...
inline ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_global_cheapest_insertion_first_solution_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:operations_research.RoutingSearchParameters.global_cheapest_insertion_first_solution_parameters)

  ClearHasBit(_impl_._has_bits_[0], 0x00000010U);
  ::operations_research::GlobalCheapestInsertionParameters* temp = _impl_.global_cheapest_insertion_first_solution_parameters_;
  _impl_.global_cheapest_insertion_first_solution_parameters_ = nullptr;
  return temp;
}
inline ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_global_cheapest_insertion_first_solution_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.global_cheapest_insertion_first_solution_parameters_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::GlobalCheapestInsertionParameters>(GetArena());
    _impl_.global_cheapest_insertion_first_solution_parameters_ = reinterpret_cast<::operations_research::GlobalCheapestInsertionParameters*>(p);
  }
  return _impl_.global_cheapest_insertion_first_solution_parameters_;
}
inline ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NONNULL RoutingSearchParameters::mutable_global_cheapest_insertion_first_solution_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000010U);
  ::operations_research::GlobalCheapestInsertionParameters* _msg = _internal_mutable_global_cheapest_insertion_first_solution_parameters();
  // @@protoc_insertion_point(field_mutable:operations_research.RoutingSearchParameters.global_cheapest_insertion_first_solution_parameters)
  return _msg;
}
inline void RoutingSearchParameters::set_allocated_global_cheapest_insertion_first_solution_parameters(::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.global_cheapest_insertion_first_solution_parameters_);
  ...
  _impl_.global_cheapest_insertion_first_solution_parameters_ = reinterpret_cast<::operations_research::GlobalCheapestInsertionParameters*>(value);
  // @@protoc_insertion_point(field_set_allocated:operations_research.RoutingSearchParameters.global_cheapest_insertion_first_solution_parameters)
}

// .operations_research.GlobalCheapestInsertionParameters global_cheapest_insertion_ls_operator_parameters = 72;
inline bool RoutingSearchParameters::has_global_cheapest_insertion_ls_operator_parameters() const {
  bool value = CheckHasBit(_impl_._has_bits_[1], 0x00000008U);
  PROTOBUF_ASSUME(!value || _impl_.global_cheapest_insertion_ls_operator_parameters_ != nullptr);
  return value;
}
inline const ::operations_research::GlobalCheapestInsertionParameters& RoutingSearchParameters::_internal_global_cheapest_insertion_ls_operator_parameters() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::operations_research::GlobalCheapestInsertionParameters* p = _impl_.global_cheapest_insertion_ls_operator_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::operations_research::GlobalCheapestInsertionParameters&>(::operations_research::_GlobalCheapestInsertionParameters_default_instance_);
}
inline const ::operations_research::GlobalCheapestInsertionParameters& RoutingSearchParameters::global_cheapest_insertion_ls_operator_parameters() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.global_cheapest_insertion_ls_operator_parameters)
  return _internal_global_cheapest_insertion_ls_operator_parameters();
}
inline void RoutingSearchParameters::unsafe_arena_set_allocated_global_cheapest_insertion_ls_operator_parameters(
    ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.global_cheapest_insertion_ls_operator_parameters_);
  }
  _impl_.global_cheapest_insertion_ls_operator_parameters_ = reinterpret_cast<::operations_research::GlobalCheapestInsertionParameters*>(value);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[1], 0x00000008U);
  } else {
    ClearHasBit(_impl_._has_bits_[1], 0x00000008U);
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:operations_research.RoutingSearchParameters.global_cheapest_insertion_ls_operator_parameters)
}
inline ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE RoutingSearchParameters::release_global_cheapest_insertion_ls_operator_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  ClearHasBit(_impl_._has_bits_[1], 0x00000008U);
  ::operations_research::GlobalCheapestInsertionParameters* released = _impl_.global_cheapest_insertion_ls_operator_parameters_;
  _impl_.global_cheapest_insertion_ls_operator_parameters_ = nullptr;
  if (::google::protobuf::internal::DebugHardenForceCopyInRelease()) {
    auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
    released = ::google::protobuf::internal::DuplicateIfNonNull(released);
    if (GetArena() == nullptr) {
...
inline ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_global_cheapest_insertion_ls_operator_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:operations_research.RoutingSearchParameters.global_cheapest_insertion_ls_operator_parameters)

  ClearHasBit(_impl_._has_bits_[1], 0x00000008U);
  ::operations_research::GlobalCheapestInsertionParameters* temp = _impl_.global_cheapest_insertion_ls_operator_parameters_;
  _impl_.global_cheapest_insertion_ls_operator_parameters_ = nullptr;
  return temp;
}
inline ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_global_cheapest_insertion_ls_operator_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.global_cheapest_insertion_ls_operator_parameters_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::GlobalCheapestInsertionParameters>(GetArena());
    _impl_.global_cheapest_insertion_ls_operator_parameters_ = reinterpret_cast<::operations_research::GlobalCheapestInsertionParameters*>(p);
  }
  return _impl_.global_cheapest_insertion_ls_operator_parameters_;
}
inline ::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NONNULL RoutingSearchParameters::mutable_global_cheapest_insertion_ls_operator_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[1], 0x00000008U);
  ::operations_research::GlobalCheapestInsertionParameters* _msg = _internal_mutable_global_cheapest_insertion_ls_operator_parameters();
  // @@protoc_insertion_point(field_mutable:operations_research.RoutingSearchParameters.global_cheapest_insertion_ls_operator_parameters)
  return _msg;
}
inline void RoutingSearchParameters::set_allocated_global_cheapest_insertion_ls_operator_parameters(::operations_research::GlobalCheapestInsertionParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.global_cheapest_insertion_ls_operator_parameters_);
  ...
  _impl_.global_cheapest_insertion_ls_operator_parameters_ = reinterpret_cast<::operations_research::GlobalCheapestInsertionParameters*>(value);
  // @@protoc_insertion_point(field_set_allocated:operations_research.RoutingSearchParameters.global_cheapest_insertion_ls_operator_parameters)
}

// .operations_research.LocalCheapestInsertionParameters local_cheapest_insertion_parameters = 68;
inline bool RoutingSearchParameters::has_local_cheapest_insertion_parameters() const {
  bool value = CheckHasBit(_impl_._has_bits_[1], 0x00000001U);
  PROTOBUF_ASSUME(!value || _impl_.local_cheapest_insertion_parameters_ != nullptr);
  return value;
}
inline const ::operations_research::LocalCheapestInsertionParameters& RoutingSearchParameters::_internal_local_cheapest_insertion_parameters() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::operations_research::LocalCheapestInsertionParameters* p = _impl_.local_cheapest_insertion_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::operations_research::LocalCheapestInsertionParameters&>(::operations_research::_LocalCheapestInsertionParameters_default_instance_);
}
inline const ::operations_research::LocalCheapestInsertionParameters& RoutingSearchParameters::local_cheapest_insertion_parameters() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.local_cheapest_insertion_parameters)
  return _internal_local_cheapest_insertion_parameters();
}
inline void RoutingSearchParameters::unsafe_arena_set_allocated_local_cheapest_insertion_parameters(
    ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.local_cheapest_insertion_parameters_);
  }
  _impl_.local_cheapest_insertion_parameters_ = reinterpret_cast<::operations_research::LocalCheapestInsertionParameters*>(value);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[1], 0x00000001U);
  } else {
    ClearHasBit(_impl_._has_bits_[1], 0x00000001U);
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:operations_research.RoutingSearchParameters.local_cheapest_insertion_parameters)
}
inline ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE RoutingSearchParameters::release_local_cheapest_insertion_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  ClearHasBit(_impl_._has_bits_[1], 0x00000001U);
  ::operations_research::LocalCheapestInsertionParameters* released = _impl_.local_cheapest_insertion_parameters_;
  _impl_.local_cheapest_insertion_parameters_ = nullptr;
  if (::google::protobuf::internal::DebugHardenForceCopyInRelease()) {
    auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
    released = ::google::protobuf::internal::DuplicateIfNonNull(released);
    if (GetArena() == nullptr) {
...
inline ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_local_cheapest_insertion_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:operations_research.RoutingSearchParameters.local_cheapest_insertion_parameters)

  ClearHasBit(_impl_._has_bits_[1], 0x00000001U);
  ::operations_research::LocalCheapestInsertionParameters* temp = _impl_.local_cheapest_insertion_parameters_;
  _impl_.local_cheapest_insertion_parameters_ = nullptr;
  return temp;
}
inline ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_local_cheapest_insertion_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.local_cheapest_insertion_parameters_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::LocalCheapestInsertionParameters>(GetArena());
    _impl_.local_cheapest_insertion_parameters_ = reinterpret_cast<::operations_research::LocalCheapestInsertionParameters*>(p);
  }
  return _impl_.local_cheapest_insertion_parameters_;
}
inline ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NONNULL RoutingSearchParameters::mutable_local_cheapest_insertion_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[1], 0x00000001U);
  ::operations_research::LocalCheapestInsertionParameters* _msg = _internal_mutable_local_cheapest_insertion_parameters();
  // @@protoc_insertion_point(field_mutable:operations_research.RoutingSearchParameters.local_cheapest_insertion_parameters)
  return _msg;
}
inline void RoutingSearchParameters::set_allocated_local_cheapest_insertion_parameters(::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.local_cheapest_insertion_parameters_);
  ...
  _impl_.local_cheapest_insertion_parameters_ = reinterpret_cast<::operations_research::LocalCheapestInsertionParameters*>(value);
  // @@protoc_insertion_point(field_set_allocated:operations_research.RoutingSearchParameters.local_cheapest_insertion_parameters)
}

// .operations_research.LocalCheapestInsertionParameters local_cheapest_cost_insertion_parameters = 69;
inline bool RoutingSearchParameters::has_local_cheapest_cost_insertion_parameters() const {
  bool value = CheckHasBit(_impl_._has_bits_[1], 0x00000002U);
  PROTOBUF_ASSUME(!value || _impl_.local_cheapest_cost_insertion_parameters_ != nullptr);
  return value;
}
inline const ::operations_research::LocalCheapestInsertionParameters& RoutingSearchParameters::_internal_local_cheapest_cost_insertion_parameters() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::operations_research::LocalCheapestInsertionParameters* p = _impl_.local_cheapest_cost_insertion_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::operations_research::LocalCheapestInsertionParameters&>(::operations_research::_LocalCheapestInsertionParameters_default_instance_);
}
inline const ::operations_research::LocalCheapestInsertionParameters& RoutingSearchParameters::local_cheapest_cost_insertion_parameters() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.local_cheapest_cost_insertion_parameters)
  return _internal_local_cheapest_cost_insertion_parameters();
}
inline void RoutingSearchParameters::unsafe_arena_set_allocated_local_cheapest_cost_insertion_parameters(
    ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.local_cheapest_cost_insertion_parameters_);
  }
  _impl_.local_cheapest_cost_insertion_parameters_ = reinterpret_cast<::operations_research::LocalCheapestInsertionParameters*>(value);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[1], 0x00000002U);
  } else {
    ClearHasBit(_impl_._has_bits_[1], 0x00000002U);
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:operations_research.RoutingSearchParameters.local_cheapest_cost_insertion_parameters)
}
inline ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE RoutingSearchParameters::release_local_cheapest_cost_insertion_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  ClearHasBit(_impl_._has_bits_[1], 0x00000002U);
  ::operations_research::LocalCheapestInsertionParameters* released = _impl_.local_cheapest_cost_insertion_parameters_;
  _impl_.local_cheapest_cost_insertion_parameters_ = nullptr;
  if (::google::protobuf::internal::DebugHardenForceCopyInRelease()) {
    auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
    released = ::google::protobuf::internal::DuplicateIfNonNull(released);
    if (GetArena() == nullptr) {
...
inline ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_local_cheapest_cost_insertion_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:operations_research.RoutingSearchParameters.local_cheapest_cost_insertion_parameters)

  ClearHasBit(_impl_._has_bits_[1], 0x00000002U);
  ::operations_research::LocalCheapestInsertionParameters* temp = _impl_.local_cheapest_cost_insertion_parameters_;
  _impl_.local_cheapest_cost_insertion_parameters_ = nullptr;
  return temp;
}
inline ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_local_cheapest_cost_insertion_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.local_cheapest_cost_insertion_parameters_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::operations_research::LocalCheapestInsertionParameters>(GetArena());
    _impl_.local_cheapest_cost_insertion_parameters_ = reinterpret_cast<::operations_research::LocalCheapestInsertionParameters*>(p);
  }
  return _impl_.local_cheapest_cost_insertion_parameters_;
}
inline ::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NONNULL RoutingSearchParameters::mutable_local_cheapest_cost_insertion_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[1], 0x00000002U);
  ::operations_research::LocalCheapestInsertionParameters* _msg = _internal_mutable_local_cheapest_cost_insertion_parameters();
  // @@protoc_insertion_point(field_mutable:operations_research.RoutingSearchParameters.local_cheapest_cost_insertion_parameters)
  return _msg;
}
inline void RoutingSearchParameters::set_allocated_local_cheapest_cost_insertion_parameters(::operations_research::LocalCheapestInsertionParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.local_cheapest_cost_insertion_parameters_);
  ...
  _impl_.local_cheapest_cost_insertion_parameters_ = reinterpret_cast<::operations_research::LocalCheapestInsertionParameters*>(value);
  // @@protoc_insertion_point(field_set_allocated:operations_research.RoutingSearchParameters.local_cheapest_cost_insertion_parameters)
}
...
inline void RoutingSearchParameters::unsafe_arena_set_allocated_local_search_operators(
    ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
...
inline ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NULLABLE RoutingSearchParameters::release_local_search_operators() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_local_search_operators() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_local_search_operators() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NONNULL RoutingSearchParameters::mutable_local_search_operators()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
...
inline void RoutingSearchParameters::set_allocated_local_search_operators(::operations_research::RoutingSearchParameters_LocalSearchNeighborhoodOperators* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.local_search_operators_);
...
inline ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL RoutingSearchParameters::mutable_local_search_metaheuristics()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBitForRepeated(_impl_._has_bits_[0], 0x10000000U);
...
RoutingSearchParameters::_internal_mutable_local_search_metaheuristics() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.local_search_metaheuristics_;
}
...
inline ::operations_research::sat::SatParameters* PROTOBUF_NULLABLE RoutingSearchParameters::release_sat_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::sat::SatParameters* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_sat_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::sat::SatParameters* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_sat_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::sat::SatParameters* PROTOBUF_NONNULL RoutingSearchParameters::mutable_sat_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x40000000U);
...
inline void RoutingSearchParameters::set_allocated_sat_parameters(::operations_research::sat::SatParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.sat_parameters_);
...
inline ::google::protobuf::Duration* PROTOBUF_NULLABLE RoutingSearchParameters::release_time_limit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::google::protobuf::Duration* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_time_limit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::google::protobuf::Duration* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_time_limit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::google::protobuf::Duration* PROTOBUF_NONNULL RoutingSearchParameters::mutable_time_limit()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000002U);
...
inline void RoutingSearchParameters::set_allocated_time_limit(::google::protobuf::Duration* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.time_limit_);
...
inline ::google::protobuf::Duration* PROTOBUF_NULLABLE RoutingSearchParameters::release_lns_time_limit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::google::protobuf::Duration* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_lns_time_limit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::google::protobuf::Duration* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_lns_time_limit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::google::protobuf::Duration* PROTOBUF_NONNULL RoutingSearchParameters::mutable_lns_time_limit()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000004U);
...
inline void RoutingSearchParameters::set_allocated_lns_time_limit(::google::protobuf::Duration* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.lns_time_limit_);
...
inline void RoutingSearchParameters::unsafe_arena_set_allocated_improvement_limit_parameters(
    ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
...
inline ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NULLABLE RoutingSearchParameters::release_improvement_limit_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_improvement_limit_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_improvement_limit_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NONNULL RoutingSearchParameters::mutable_improvement_limit_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000008U);
...
inline void RoutingSearchParameters::set_allocated_improvement_limit_parameters(::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.improvement_limit_parameters_);
...
PROTOBUF_ALWAYS_INLINE void RoutingSearchParameters::set_log_tag(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  SetHasBit(_impl_._has_bits_[0], 0x20000000U);
...
inline ::std::string* PROTOBUF_NONNULL RoutingSearchParameters::mutable_log_tag()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x20000000U);
...
inline ::std::string* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_log_tag() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.log_tag_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE RoutingSearchParameters::release_log_tag() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  auto* released = _impl_.log_tag_.Release();
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString()) {
    _impl_.log_tag_.Set("", GetArena());
  }
  return released;
}
inline void RoutingSearchParameters::set_allocated_log_tag(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[0], 0x20000000U);
  } else {
...
inline void RoutingSearchParameters::unsafe_arena_set_allocated_iterated_local_search_parameters(
    ::operations_research::IteratedLocalSearchParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
...
inline ::operations_research::IteratedLocalSearchParameters* PROTOBUF_NULLABLE RoutingSearchParameters::release_iterated_local_search_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::IteratedLocalSearchParameters* PROTOBUF_NULLABLE RoutingSearchParameters::unsafe_arena_release_iterated_local_search_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::IteratedLocalSearchParameters* PROTOBUF_NONNULL RoutingSearchParameters::_internal_mutable_iterated_local_search_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::IteratedLocalSearchParameters* PROTOBUF_NONNULL RoutingSearchParameters::mutable_iterated_local_search_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x80000000U);
...
inline void RoutingSearchParameters::set_allocated_iterated_local_search_parameters(::operations_research::IteratedLocalSearchParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.iterated_local_search_parameters_);
...
inline void RoutingModelParameters::unsafe_arena_set_allocated_solver_parameters(
    ::operations_research::ConstraintSolverParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
...
inline ::operations_research::ConstraintSolverParameters* PROTOBUF_NULLABLE RoutingModelParameters::release_solver_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::ConstraintSolverParameters* PROTOBUF_NULLABLE RoutingModelParameters::unsafe_arena_release_solver_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::ConstraintSolverParameters* PROTOBUF_NONNULL RoutingModelParameters::_internal_mutable_solver_parameters() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::operations_research::ConstraintSolverParameters* PROTOBUF_NONNULL RoutingModelParameters::mutable_solver_parameters()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
...
inline void RoutingModelParameters::set_allocated_solver_parameters(::operations_research::ConstraintSolverParameters* PROTOBUF_NULLABLE value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.solver_parameters_);
...
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::operations_research::RoutingSearchParameters_SchedulingSolver>() {

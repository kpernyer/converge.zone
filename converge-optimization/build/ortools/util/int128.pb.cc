...
PROTOBUF_CONSTEXPR Int128::Int128(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(Int128_class_data_.base()),
...
const ::uint32_t
    TableStruct_ortools_2futil_2fint128_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::operations_research::Int128, _impl_._has_bits_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::operations_research::Int128)},
};
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, Int128_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull Int128_class_data_ =
        Int128::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
Int128::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&Int128_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(Int128_class_data_.tc_table);
...
Int128::_table_ = {
  {
    ...
    // uint64 low = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(Int128, _impl_.low_), 1>(),
     {16, 1, 0,
      PROTOBUF_FIELD_OFFSET(Int128, _impl_.low_)}},
    // int64 high = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(Int128, _impl_.high_), 0>(),
     {8, 0, 0,
    ...
    // int64 high = 1;
    {PROTOBUF_FIELD_OFFSET(Int128, _impl_.high_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    // uint64 low = 2;
